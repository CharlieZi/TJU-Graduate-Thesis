...
\begin{figure}[!htb]
	\centering
	\subfigure[]{
		\includegraphics[height=0.2\textheight]{"figure/experiment/hose-angle-testing"}\label{fig:ranse}
		}		
	\hspace{1cm}
	\subfigure[]{
		\includegraphics[height=0.2\textheight]{"figure/experiment/hose-angle-testing-2"}\label{fig:wenlu}}
...
\subsection{力位移曲线}
力位移曲线如图\ref{fig:experiment-2}所示，
